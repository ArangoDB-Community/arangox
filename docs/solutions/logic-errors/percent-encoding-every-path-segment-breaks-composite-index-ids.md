...
The fix sits on `feat/v0-8-modernization`, open as pull request #10 and not yet merged to `main`. Commit identifiers on that branch can be rewritten by a rebase or squash before it lands, so this doc cites file and line rather than a revision.
